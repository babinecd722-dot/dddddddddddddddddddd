.class public final Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;
...
# instance fields
.field public audioFormatBitrateTimeProduct:J
...
.field public audioFormatTimeMs:J

.field public audioUnderruns:J

.field public bandwidthBytes:J

.field public bandwidthTimeMs:J
...
.field public currentPlaybackStateStartTimeMs:J
...
.field public droppedFrames:J

.field public fatalErrorCount:I
...
.field public firstReportedTimeMs:J

.field public hasBeenReady:Z

.field public hasEnded:Z

.field public hasFatalError:Z

.field public initialAudioFormatBitrate:J

.field public initialVideoFormatBitrate:J

.field public initialVideoFormatHeight:I

.field public final isAd:Z

.field public isForeground:Z

.field public isInterruptedByAd:Z

.field public isJoinTimeInvalid:Z

.field public isSeeking:Z

.field public final keepHistory:Z

.field public lastAudioFormatStartTimeMs:J

.field public lastRebufferStartTimeMs:J

.field public lastVideoFormatStartTimeMs:J

.field public maxRebufferTimeMs:J
...
.field public nonFatalErrorCount:I
...
.field public pauseBufferCount:I

.field public pauseCount:I
...
.field public rebufferCount:I

.field public seekCount:I

.field public startedLoading:Z

.field public videoFormatBitrateTimeMs:J

.field public videoFormatBitrateTimeProduct:J

.field public videoFormatHeightTimeMs:J

.field public videoFormatHeightTimeProduct:J
...
.method public static isInvalidJoinTransition(II)Z
    .locals 4
...
.method public static isReadyState(I)Z
    .locals 1
...
.method public static isRebufferingState(I)Z
    .locals 1
...
.method public build(Z)Landroidx/media3/exoplayer/analytics/PlaybackStats;
    ...
    .line 597
    invoke-virtual {v0, v1, v2}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateMaxRebufferTimeMs(J)V

    .line 598
    invoke-virtual {v0, v1, v2}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeRecordVideoFormatTime(J)V

    .line 599
    invoke-virtual {v0, v1, v2}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeRecordAudioFormatTime(J)V
    ...
    .line 602
    invoke-virtual {v0, v1, v2}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->guessMediaTimeBasedOnElapsedRealtime(J)[J
...
.method public final guessMediaTimeBasedOnElapsedRealtime(J)[J
    .locals 7
...
.method public final maybeRecordAudioFormatTime(J)V
    .locals 7
...
.method public final maybeRecordVideoFormatTime(J)V
    .locals 9
...
.method public final maybeUpdateAudioFormat(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;Landroidx/media3/common/Format;)V
    .locals 4
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeRecordAudioFormatTime(J)V
...
.method public final maybeUpdateMaxRebufferTimeMs(J)V
    .locals 4
...
.method public final maybeUpdateMediaTimeHistory(JJ)V
    .locals 9
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->guessMediaTimeBasedOnElapsedRealtime(J)[J
...
.method public final maybeUpdateVideoFormat(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;Landroidx/media3/common/Format;)V
    .locals 6
    .param p2    # Landroidx/media3/common/Format;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeRecordVideoFormatTime(J)V
...
.method public onEvents(Landroidx/media3/common/Player;Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;ZJZIZZLandroidx/media3/common/PlaybackException;Ljava/lang/Exception;JJLandroidx/media3/common/Format;Landroidx/media3/common/Format;Landroidx/media3/common/VideoSize;)V
    ...
    invoke-virtual {p0, v13, v14, v2, v3}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateMediaTimeHistory(JJ)V
    ...
    .line 529
    invoke-virtual {p0, v1, v4}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateVideoFormat(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;Landroidx/media3/common/Format;)V
    ...
    .line 532
    invoke-virtual {p0, v1, v4}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateAudioFormat(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;Landroidx/media3/common/Format;)V

    :cond_7
    if-eqz v6, :cond_8

    .line 536
    invoke-virtual {p0, v1, v6}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateVideoFormat(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;Landroidx/media3/common/Format;)V

    :cond_8
    if-eqz v7, :cond_9

    .line 539
    invoke-virtual {p0, v1, v7}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateAudioFormat(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;Landroidx/media3/common/Format;)V
    ...
    .line 550
    invoke-virtual {p0, v1, v2}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateVideoFormat(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;Landroidx/media3/common/Format;)V
    ...
    .line 568
    :cond_d
    invoke-virtual/range {p0 .. p1}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->resolveNewPlaybackState(Landroidx/media3/common/Player;)I
    ...
    .line 571
    :cond_f
    invoke-virtual {p0, v4, v5, v9, v10}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateMediaTimeHistory(JJ)V

    .line 574
    iget-wide v4, v1, Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;->realtimeMs:J

    invoke-virtual {p0, v4, v5}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeRecordVideoFormatTime(J)V

    .line 575
    iget-wide v4, v1, Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;->realtimeMs:J

    invoke-virtual {p0, v4, v5}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeRecordAudioFormatTime(J)V
    ...
    .line 579
    invoke-virtual {p0, v2, v1}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->updatePlaybackState(ILandroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;)V
...
.method public onFinished(Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;ZJ)V
    ...
    invoke-virtual {p0, v2, v3, p3, p4}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateMediaTimeHistory(JJ)V

    .line 463
    iget-wide p2, p1, Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;->realtimeMs:J

    invoke-virtual {p0, p2, p3}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeRecordVideoFormatTime(J)V

    .line 464
    iget-wide p2, p1, Landroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;->realtimeMs:J

    invoke-virtual {p0, p2, p3}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeRecordAudioFormatTime(J)V

    .line 465
    invoke-virtual {p0, v1, p1}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->updatePlaybackState(ILandroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;)V
...
.method public final updatePlaybackState(ILandroidx/media3/exoplayer/analytics/AnalyticsListener$EventTime;)V
    .locals 10
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/media3/exoplayer/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateMaxRebufferTimeMs(J)V
