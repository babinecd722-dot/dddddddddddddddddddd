.class public final Landroidx/compose/ui/text/font/TypefaceBuilderCompat;
...
.method public final createFromAssets(Landroid/content/res/AssetManager;Ljava/lang/String;Landroid/content/Context;Landroidx/compose/ui/text/font/FontVariation$Settings;)Landroid/graphics/Typeface;
    ...
    .line 180
    :cond_0
    invoke-static {p1, p2}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat$$ExternalSyntheticApiModelOutline3;->m(Landroid/content/res/AssetManager;Ljava/lang/String;)Landroid/graphics/Typeface$Builder;

    move-result-object p1

    .line 181
    invoke-virtual {p0, p4, p3}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat;->toVariationSettings(Landroidx/compose/ui/text/font/FontVariation$Settings;Landroid/content/Context;)[Landroid/graphics/fonts/FontVariationAxis;

    move-result-object p2

    invoke-static {p1, p2}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Typeface$Builder;[Landroid/graphics/fonts/FontVariationAxis;)Landroid/graphics/Typeface$Builder;

    move-result-object p1

    .line 182
    invoke-static {p1}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/Typeface$Builder;)Landroid/graphics/Typeface;
...
.method public final createFromFile(Ljava/io/File;Landroid/content/Context;Landroidx/compose/ui/text/font/FontVariation$Settings;)Landroid/graphics/Typeface;
    ...
    .line 195
    :cond_0
    invoke-static {p1}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat$$ExternalSyntheticApiModelOutline2;->m(Ljava/io/File;)Landroid/graphics/Typeface$Builder;

    move-result-object p1

    .line 196
    invoke-virtual {p0, p3, p2}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat;->toVariationSettings(Landroidx/compose/ui/text/font/FontVariation$Settings;Landroid/content/Context;)[Landroid/graphics/fonts/FontVariationAxis;
...
.method public final createFromFileDescriptor(Landroid/os/ParcelFileDescriptor;Landroid/content/Context;Landroidx/compose/ui/text/font/FontVariation$Settings;)Landroid/graphics/Typeface;
    ...
    .line 210
    :cond_0
    invoke-static {}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat$$ExternalSyntheticApiModelOutline7;->m()V

    invoke-virtual {p1}, Landroid/os/ParcelFileDescriptor;->getFileDescriptor()Ljava/io/FileDescriptor;

    move-result-object p1

    invoke-static {p1}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat$$ExternalSyntheticApiModelOutline6;->m(Ljava/io/FileDescriptor;)Landroid/graphics/Typeface$Builder;
...
.method public final toVariationSettings(Landroidx/compose/ui/text/font/FontVariation$Settings;Landroid/content/Context;)[Landroid/graphics/fonts/FontVariationAxis;
    .locals 6
    .annotation build Landroidx/annotation/RequiresApi;
        value = 0x1a
    .end annotation
    ...
    .line 230
    invoke-static {}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat$$ExternalSyntheticApiModelOutline5;->m()V
    ...
    invoke-static {v5, v4}, Landroidx/compose/ui/text/font/TypefaceBuilderCompat$$ExternalSyntheticApiModelOutline4;->m(Ljava/lang/String;F)Landroid/graphics/fonts/FontVariationAxis;
