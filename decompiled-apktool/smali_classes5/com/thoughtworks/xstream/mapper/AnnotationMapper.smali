...
# instance fields
.field public final annotatedTypes:Ljava/util/Set;
...
.field public transient arguments:[Ljava/lang/Object;

.field public transient attributeMapper:Lcom/thoughtworks/xstream/mapper/AttributeMapper;

.field public transient classAliasingMapper:Lcom/thoughtworks/xstream/mapper/ClassAliasingMapper;

.field public final converterCache:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/Class<",
...
.field public final converterRegistry:Lcom/thoughtworks/xstream/converters/ConverterRegistry;

.field public transient defaultImplementationsMapper:Lcom/thoughtworks/xstream/mapper/DefaultImplementationsMapper;

.field public transient elementIgnoringMapper:Lcom/thoughtworks/xstream/mapper/ElementIgnoringMapper;

.field public transient fieldAliasingMapper:Lcom/thoughtworks/xstream/mapper/FieldAliasingMapper;

.field public transient implicitCollectionMapper:Lcom/thoughtworks/xstream/mapper/ImplicitCollectionMapper;

.field public transient localConversionMapper:Lcom/thoughtworks/xstream/mapper/LocalConversionMapper;
...
.method public constructor <init>(Lcom/thoughtworks/xstream/mapper/Mapper;Lcom/thoughtworks/xstream/converters/ConverterRegistry;Lcom/thoughtworks/xstream/converters/ConverterLookup;Lcom/thoughtworks/xstream/core/ClassLoaderReference;Lcom/thoughtworks/xstream/converters/reflection/ReflectionProvider;)V
    ...
    .line 92
    invoke-virtual {p0}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->setupMappers()V
    ...
    .line 96
    new-instance v4, Lcom/thoughtworks/xstream/core/JVM;

    invoke-direct {v4}, Lcom/thoughtworks/xstream/core/JVM;-><init>()V
    ...
    :cond_0
    new-instance p1, Lcom/thoughtworks/xstream/core/util/TypedNull;

    const-class p2, Ljava/lang/ClassLoader;

    invoke-direct {p1, p2}, Lcom/thoughtworks/xstream/core/util/TypedNull;-><init>(Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->arguments:[Ljava/lang/Object;
...
# virtual methods
.method public final addParametrizedTypes(Ljava/lang/reflect/Type;Ljava/util/Set;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final cacheConverter(Lcom/thoughtworks/xstream/annotations/XStreamConverter;Ljava/lang/Class;)Lcom/thoughtworks/xstream/converters/Converter;
    .locals 7
...
.method public defaultImplementationOf(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    .line 134
    invoke-virtual {p0, p1}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processAnnotations(Ljava/lang/Class;)V
...
.method public final getClass(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final processAliasAnnotation(Ljava/lang/Class;Ljava/util/Set;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final processAliasTypeAnnotation(Ljava/lang/Class;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final processAnnotations(Ljava/lang/Class;)V
    .locals 2
    ...
    .line 175
    invoke-virtual {p0, v0}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processTypes(Ljava/util/Set;)V
...
.method public final processAsAttributeAnnotation(Ljava/lang/reflect/Field;)V
    .locals 2
...
.method public final processConverterAnnotations(Ljava/lang/Class;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 301
    :goto_2
    invoke-virtual {p0, v2, v3}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->cacheConverter(Lcom/thoughtworks/xstream/annotations/XStreamConverter;Ljava/lang/Class;)Lcom/thoughtworks/xstream/converters/Converter;
...
.method public final processFieldAliasAnnotation(Ljava/lang/reflect/Field;)V
    .locals 3
...
.method public final processImplicitAnnotation(Ljava/lang/reflect/Field;)V
    .locals 8
    ...
    .line 435
    invoke-virtual {p0, v3}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->getClass(Ljava/lang/reflect/Type;)Ljava/lang/Class;
...
.method public final processImplicitCollectionAnnotation(Ljava/lang/Class;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v1, Lcom/thoughtworks/xstream/annotations/XStreamImplicitCollection;
    ...
    .line 359
    invoke-interface {v1}, Lcom/thoughtworks/xstream/annotations/XStreamImplicitCollection;->value()Ljava/lang/String;

    move-result-object v2

    .line 360
    invoke-interface {v1}, Lcom/thoughtworks/xstream/annotations/XStreamImplicitCollection;->item()Ljava/lang/String;
    ...
    .line 376
    invoke-virtual {p0, v0}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->getClass(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-virtual {v0, p1, v2, v4, v1}, Lcom/thoughtworks/xstream/mapper/ImplicitCollectionMapper;->add(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    invoke-virtual {v1, p1, v2, v4, v0}, Lcom/thoughtworks/xstream/mapper/ImplicitCollectionMapper;->add(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)V
    ...
    invoke-direct {v1, p1}, Lcom/thoughtworks/xstream/InitializationException;-><init>(Ljava/lang/String;)V
...
.method public final processLocalConverterAnnotation(Ljava/lang/reflect/Field;)V
    .locals 3
    ...
    invoke-virtual {p0, v0, v1}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->cacheConverter(Lcom/thoughtworks/xstream/annotations/XStreamConverter;Ljava/lang/Class;)Lcom/thoughtworks/xstream/converters/Converter;
...
.method public final processOmitFieldAnnotation(Ljava/lang/reflect/Field;)V
    .locals 2
...
.method public final processTypes(Ljava/util/Set;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :try_start_3
    invoke-virtual {p0, v1, p1}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->addParametrizedTypes(Ljava/lang/reflect/Type;Ljava/util/Set;)V

    .line 195
    invoke-virtual {p0, v1}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processConverterAnnotations(Ljava/lang/Class;)V

    .line 196
    invoke-virtual {p0, v1, p1}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processAliasAnnotation(Ljava/lang/Class;Ljava/util/Set;)V

    .line 197
    invoke-virtual {p0, v1}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processAliasTypeAnnotation(Ljava/lang/Class;)V
    ...
    :cond_2
    :try_start_5
    invoke-virtual {p0, v1}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processImplicitCollectionAnnotation(Ljava/lang/Class;)V
    ...
    invoke-virtual {p0, v4, p1}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->addParametrizedTypes(Ljava/lang/reflect/Type;Ljava/util/Set;)V
    ...
    .line 219
    :cond_4
    invoke-virtual {p0, v3}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processFieldAliasAnnotation(Ljava/lang/reflect/Field;)V

    .line 220
    invoke-virtual {p0, v3}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processAsAttributeAnnotation(Ljava/lang/reflect/Field;)V

    .line 221
    invoke-virtual {p0, v3}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processImplicitAnnotation(Ljava/lang/reflect/Field;)V

    .line 222
    invoke-virtual {p0, v3}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processOmitFieldAnnotation(Ljava/lang/reflect/Field;)V

    .line 223
    invoke-virtual {p0, v3}, Lcom/thoughtworks/xstream/mapper/AnnotationMapper;->processLocalConverterAnnotation(Ljava/lang/reflect/Field;)V
    :try_end_5
...
.method public final setupMappers()V
    .locals 1
