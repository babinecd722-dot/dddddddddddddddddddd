...
# static fields
.field public static final PERMISSIONS:[Lcom/thoughtworks/xstream/security/TypePermission;
...
.method static constructor <clinit>()V
    ...
    new-instance v3, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;
    ...
    :cond_2
    invoke-direct {v3, v4}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V
    ...
    new-instance v5, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v6, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$javabean$JavaBeanProvider:Ljava/lang/Class;

    if-nez v6, :cond_4

    const-string v6, "com.thoughtworks.xstream.converters.javabean.JavaBeanProvider"
    ...
    sput-object v6, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$javabean$JavaBeanProvider:Ljava/lang/Class;

    :cond_4
    invoke-direct {v5, v6}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v6, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v7, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$reflection$FieldKeySorter:Ljava/lang/Class;

    if-nez v7, :cond_5

    const-string v7, "com.thoughtworks.xstream.converters.reflection.FieldKeySorter"

    .line 59
    invoke-static {v7}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v7

    sput-object v7, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$reflection$FieldKeySorter:Ljava/lang/Class;

    :cond_5
    invoke-direct {v6, v7}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v7, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v8, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$ConverterLookup:Ljava/lang/Class;

    if-nez v8, :cond_6

    const-string v8, "com.thoughtworks.xstream.converters.ConverterLookup"

    .line 60
    invoke-static {v8}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v8

    sput-object v8, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$ConverterLookup:Ljava/lang/Class;

    :cond_6
    invoke-direct {v7, v8}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v8, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v9, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$ConverterRegistry:Ljava/lang/Class;

    if-nez v9, :cond_7

    const-string v9, "com.thoughtworks.xstream.converters.ConverterRegistry"

    .line 61
    invoke-static {v9}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v9

    sput-object v9, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$ConverterRegistry:Ljava/lang/Class;

    :cond_7
    invoke-direct {v8, v9}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v9, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v10, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$io$HierarchicalStreamDriver:Ljava/lang/Class;

    if-nez v10, :cond_8

    const-string v10, "com.thoughtworks.xstream.io.HierarchicalStreamDriver"

    .line 62
    invoke-static {v10}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v10

    sput-object v10, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$io$HierarchicalStreamDriver:Ljava/lang/Class;

    :cond_8
    invoke-direct {v9, v10}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v10, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v11, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$MarshallingStrategy:Ljava/lang/Class;

    if-nez v11, :cond_9

    const-string v11, "com.thoughtworks.xstream.MarshallingStrategy"

    .line 63
    invoke-static {v11}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v11

    sput-object v11, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$MarshallingStrategy:Ljava/lang/Class;

    :cond_9
    invoke-direct {v10, v11}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v11, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v12, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$MarshallingContext:Ljava/lang/Class;

    if-nez v12, :cond_a

    const-string v12, "com.thoughtworks.xstream.converters.MarshallingContext"

    .line 64
    invoke-static {v12}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v12

    sput-object v12, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$MarshallingContext:Ljava/lang/Class;

    :cond_a
    invoke-direct {v11, v12}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v12, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v13, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$UnmarshallingContext:Ljava/lang/Class;

    if-nez v13, :cond_b

    const-string v13, "com.thoughtworks.xstream.converters.UnmarshallingContext"

    .line 65
    invoke-static {v13}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v13

    sput-object v13, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$converters$UnmarshallingContext:Ljava/lang/Class;

    :cond_b
    invoke-direct {v12, v13}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v13, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v14, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$io$naming$NameCoder:Ljava/lang/Class;

    if-nez v14, :cond_c

    const-string v14, "com.thoughtworks.xstream.io.naming.NameCoder"

    .line 66
    invoke-static {v14}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v14

    sput-object v14, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$io$naming$NameCoder:Ljava/lang/Class;

    :cond_c
    invoke-direct {v13, v14}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v14, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v15, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$security$TypePermission:Ljava/lang/Class;

    if-nez v15, :cond_d

    const-string v15, "com.thoughtworks.xstream.security.TypePermission"

    .line 67
    invoke-static {v15}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v15

    sput-object v15, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$security$TypePermission:Ljava/lang/Class;

    :cond_d
    invoke-direct {v14, v15}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    new-instance v15, Lcom/thoughtworks/xstream/security/WildcardTypePermission;

    new-instance v0, Ljava/lang/StringBuffer;

    invoke-direct {v0}, Ljava/lang/StringBuffer;-><init>()V

    sget-object v16, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$core$JVM:Ljava/lang/Class;

    if-nez v16, :cond_e

    const-string v16, "com.thoughtworks.xstream.core.JVM"

    .line 68
    invoke-static/range {v16 .. v16}, Lcom/thoughtworks/xstream/XStreamer;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v16

    sput-object v16, Lcom/thoughtworks/xstream/XStreamer;->class$com$thoughtworks$xstream$core$JVM:Ljava/lang/Class;
    ...
    invoke-direct {v15, v14, v0}, Lcom/thoughtworks/xstream/security/WildcardTypePermission;-><init>(Z[Ljava/lang/String;)V

    new-instance v0, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;

    sget-object v14, Lcom/thoughtworks/xstream/XStreamer;->class$javax$xml$datatype$DatatypeFactory:Ljava/lang/Class;

    if-nez v14, :cond_f

    const-string v14, "javax.xml.datatype.DatatypeFactory"
    ...
    sput-object v14, Lcom/thoughtworks/xstream/XStreamer;->class$javax$xml$datatype$DatatypeFactory:Ljava/lang/Class;

    :cond_f
    invoke-direct {v0, v14}, Lcom/thoughtworks/xstream/security/TypeHierarchyPermission;-><init>(Ljava/lang/Class;)V

    const/16 v14, 0x10

    new-array v14, v14, [Lcom/thoughtworks/xstream/security/TypePermission;
    ...
    sput-object v14, Lcom/thoughtworks/xstream/XStreamer;->PERMISSIONS:[Lcom/thoughtworks/xstream/security/TypePermission;
