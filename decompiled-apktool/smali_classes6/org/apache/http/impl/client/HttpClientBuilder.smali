...
.field public authSchemeRegistry:Lorg/apache/http/config/Lookup;
...
.field public backoffManager:Lorg/apache/http/client/BackoffManager;
...
.field public connManager:Lorg/apache/http/conn/HttpClientConnectionManager;

.field public connManagerShared:Z

.field public connTimeToLive:J

.field public connTimeToLiveTimeUnit:Ljava/util/concurrent/TimeUnit;

.field public connectionBackoffStrategy:Lorg/apache/http/client/ConnectionBackoffStrategy;

.field public connectionStateDisabled:Z

.field public contentCompressionDisabled:Z

.field public contentDecoderMap:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field public cookieSpecRegistry:Lorg/apache/http/config/Lookup;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lorg/apache/http/config/Lookup<",
...
.field public cookieStore:Lorg/apache/http/client/CookieStore;

.field public credentialsProvider:Lorg/apache/http/client/CredentialsProvider;

.field public defaultConnectionConfig:Lorg/apache/http/config/ConnectionConfig;
...
.field public defaultRequestConfig:Lorg/apache/http/client/config/RequestConfig;

.field public defaultSocketConfig:Lorg/apache/http/config/SocketConfig;

.field public defaultUserAgentDisabled:Z

.field public dnsResolver:Lorg/apache/http/conn/DnsResolver;

.field public evictExpiredConnections:Z

.field public evictIdleConnections:Z
...
.field public keepAliveStrategy:Lorg/apache/http/conn/ConnectionKeepAliveStrategy;

.field public maxConnPerRoute:I

.field public maxConnTotal:I

.field public maxIdleTime:J

.field public maxIdleTimeUnit:Ljava/util/concurrent/TimeUnit;

.field public proxy:Lorg/apache/http/HttpHost;

.field public proxyAuthStrategy:Lorg/apache/http/client/AuthenticationStrategy;

.field public publicSuffixMatcher:Lorg/apache/http/conn/util/PublicSuffixMatcher;

.field public redirectHandlingDisabled:Z

.field public redirectStrategy:Lorg/apache/http/client/RedirectStrategy;

.field public requestExec:Lorg/apache/http/protocol/HttpRequestExecutor;
...
.field public retryHandler:Lorg/apache/http/client/HttpRequestRetryHandler;

.field public reuseStrategy:Lorg/apache/http/ConnectionReuseStrategy;

.field public routePlanner:Lorg/apache/http/conn/routing/HttpRoutePlanner;

.field public schemePortResolver:Lorg/apache/http/conn/SchemePortResolver;

.field public serviceUnavailStrategy:Lorg/apache/http/client/ServiceUnavailableRetryStrategy;

.field public sslContext:Ljavax/net/ssl/SSLContext;

.field public sslSocketFactory:Lorg/apache/http/conn/socket/LayeredConnectionSocketFactory;

.field public systemProperties:Z

.field public targetAuthStrategy:Lorg/apache/http/client/AuthenticationStrategy;

.field public userAgent:Ljava/lang/String;

.field public userTokenHandler:Lorg/apache/http/client/UserTokenHandler;
...
.method public build()Lorg/apache/http/impl/client/CloseableHttpClient;
    ...
    invoke-direct {v5, v13}, Lorg/apache/http/conn/ssl/DefaultHostnameVerifier;-><init>(Lorg/apache/http/conn/util/PublicSuffixMatcher;)V
    ...
    invoke-direct/range {v15 .. v22}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;-><init>(Lorg/apache/http/config/Registry;Lorg/apache/http/conn/HttpConnectionFactory;Lorg/apache/http/conn/SchemePortResolver;Lorg/apache/http/conn/DnsResolver;JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-direct {v14, v5}, Lorg/apache/http/protocol/RequestUserAgent;-><init>(Ljava/lang/String;)V

    move-object/from16 v17, v5

    new-array v5, v12, [Lorg/apache/http/HttpRequestInterceptor;

    aput-object v0, v5, v10

    aput-object v14, v5, v11

    invoke-direct {v2, v5}, Lorg/apache/http/protocol/ImmutableHttpProcessor;-><init>([Lorg/apache/http/HttpRequestInterceptor;)V
    ...
    .line 1092
    :cond_1a
    new-instance v2, Lorg/apache/http/client/protocol/RequestDefaultHeaders;

    iget-object v3, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->defaultHeaders:Ljava/util/Collection;

    invoke-direct {v2, v3}, Lorg/apache/http/client/protocol/RequestDefaultHeaders;-><init>(Ljava/util/Collection;)V
    ...
    invoke-direct {v6, v14}, Lorg/apache/http/protocol/RequestUserAgent;-><init>(Ljava/lang/String;)V
    ...
    new-array v8, v8, [Lorg/apache/http/HttpRequestInterceptor;
    ...
    invoke-virtual {v1, v8}, Lorg/apache/http/protocol/HttpProcessorBuilder;->addAll([Lorg/apache/http/HttpRequestInterceptor;)Lorg/apache/http/protocol/HttpProcessorBuilder;
    ...
    .line 1201
    invoke-static {v13}, Lorg/apache/http/impl/client/CookieSpecRegistries;->createDefault(Lorg/apache/http/conn/util/PublicSuffixMatcher;)Lorg/apache/http/config/Lookup;
    ...
    .line 1225
    :cond_36
    iget-boolean v6, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->evictExpiredConnections:Z

    if-nez v6, :cond_38

    iget-boolean v6, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->evictIdleConnections:Z
    ...
    :cond_38
    :goto_15
    new-instance v6, Lorg/apache/http/impl/client/IdleConnectionEvictor;

    iget-wide v7, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->maxIdleTime:J
    ...
    :goto_16
    iget-object v10, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->maxIdleTimeUnit:Ljava/util/concurrent/TimeUnit;
    ...
    invoke-direct/range {v15 .. v22}, Lorg/apache/http/impl/client/IdleConnectionEvictor;-><init>(Lorg/apache/http/conn/HttpClientConnectionManager;JLjava/util/concurrent/TimeUnit;JLjava/util/concurrent/TimeUnit;)V

    .line 1229
    new-instance v7, Lorg/apache/http/impl/client/HttpClientBuilder$1;

    invoke-direct {v7, v9, v6}, Lorg/apache/http/impl/client/HttpClientBuilder$1;-><init>(Lorg/apache/http/impl/client/HttpClientBuilder;Lorg/apache/http/impl/client/IdleConnectionEvictor;)V

    invoke-interface {v14, v7}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 1242
    invoke-virtual {v6}, Lorg/apache/http/impl/client/IdleConnectionEvictor;->start()V

    .line 1244
    :goto_19
    new-instance v6, Lorg/apache/http/impl/client/HttpClientBuilder$2;

    invoke-direct {v6, v9, v11}, Lorg/apache/http/impl/client/HttpClientBuilder$2;-><init>(Lorg/apache/http/impl/client/HttpClientBuilder;Lorg/apache/http/conn/HttpClientConnectionManager;)V
