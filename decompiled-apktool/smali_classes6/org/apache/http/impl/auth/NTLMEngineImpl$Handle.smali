...
.method public constructor <init>([BLorg/apache/http/impl/auth/NTLMEngineImpl$Mode;Z)V
    ...
    .line 814
    invoke-virtual {p0}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Handle;->initCipher()Ljavax/crypto/Cipher;
...
# virtual methods
.method public final advanceMessageSequence()V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/http/impl/auth/NTLMEngineException;
...
.method public final computeSignature([B)[B
    .locals 4
    ...
    .line 893
    invoke-virtual {p0, v3}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Handle;->encrypt([B)[B
...
.method public decryptAndVerifySignedMessage([B)[B
    ...
    .line 928
    invoke-virtual {p0, v4}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Handle;->decrypt([B)[B

    move-result-object p1

    .line 929
    invoke-virtual {p0, v1, p1}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Handle;->validateSignature([B[B)Z
    ...
    .line 933
    invoke-virtual {p0}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Handle;->advanceMessageSequence()V
...
.method public final initCipher()Ljavax/crypto/Cipher;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/http/impl/auth/NTLMEngineException;
...
.method public signAndEncryptMessage([B)[B
    ...
    .line 913
    invoke-virtual {p0, p1}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Handle;->encrypt([B)[B

    move-result-object v0

    .line 914
    invoke-virtual {p0, p1}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Handle;->computeSignature([B)[B
...
.method public final validateSignature([B[B)Z
    .locals 0

    .line 904
    invoke-virtual {p0, p2}, Lorg/apache/http/impl/auth/NTLMEngineImpl$Handle;->computeSignature([B)[B
