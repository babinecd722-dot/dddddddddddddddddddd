...
.method public static accumulate(Ljava/nio/file/Path;I[Ljava/nio/file/FileVisitOption;)Lorg/apache/commons/io/file/AccumulatorPathVisitor;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static varargs copyFile(Ljava/net/URL;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;
    ...
    .line 248
    :try_start_0
    invoke-static {p0, p1, p2}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline13;->m(Ljava/io/InputStream;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)J
    :try_end_0
...
.method public static varargs copyFileToDirectory(Ljava/net/URL;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;
    ...
    invoke-static {p1, p0}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticApiModelOutline5;->m(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/Path;

    move-result-object p0

    invoke-static {v0, p0, p2}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline13;->m(Ljava/io/InputStream;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static varargs copyFileToDirectory(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;
    ...
    invoke-static {p1, v0}, Lio/ktor/util/NioPathKt$$ExternalSyntheticApiModelOutline6;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static current()Ljava/nio/file/Path;
    ...
    invoke-static {v1, v0}, Lcom/fasterxml/jackson/databind/ext/NioPathDeserializer$$ExternalSyntheticApiModelOutline1;->m(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
...
.method public static varargs delete(Ljava/nio/file/Path;[Lorg/apache/commons/io/file/DeleteOption;)Lorg/apache/commons/io/file/Counters$PathCounters;
    ...
    invoke-static {p0, v0}, Lkotlin/io/path/DefaultCopyActionContext$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method public static varargs deleteFile(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;[Lorg/apache/commons/io/file/DeleteOption;)Lorg/apache/commons/io/file/Counters$PathCounters;
    ...
    .line 479
    :cond_3
    invoke-static {}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticApiModelOutline24;->m()V
    ...
    invoke-static {p0}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline16;->m(Ljava/lang/String;)Ljava/nio/file/NoSuchFileException;
...
.method public static directoryAndFileContentEquals(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;[Ljava/nio/file/OpenOption;[Ljava/nio/file/FileVisitOption;)Z
    ...
    invoke-static {p0, v2}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline4;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p1, v2}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline4;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    .line 547
    invoke-static {p0, v3}, Lio/ktor/util/NioPathKt$$ExternalSyntheticApiModelOutline6;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;

    move-result-object v4

    invoke-static {p1, v3}, Lio/ktor/util/NioPathKt$$ExternalSyntheticApiModelOutline6;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static fileContentEquals(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;[Ljava/nio/file/OpenOption;)Z
    ...
    .line 626
    invoke-static {p1}, Lio/ktor/util/NioPathKt$$ExternalSyntheticApiModelOutline3;->m(Ljava/nio/file/Path;)Ljava/nio/file/Path;

    move-result-object v3

    .line 627
    invoke-static {v2, p2}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z

    move-result v4

    .line 628
    invoke-static {v3, p2}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    .line 636
    :cond_3
    invoke-static {v2, p2}, Lkotlin/io/path/DefaultCopyActionContext$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    .line 640
    invoke-static {v3, p2}, Lkotlin/io/path/DefaultCopyActionContext$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    .line 644
    invoke-static {v2}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline12;->m(Ljava/nio/file/Path;)J

    move-result-wide v4

    invoke-static {v3}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline12;->m(Ljava/nio/file/Path;)J
    ...
    .line 648
    :cond_4
    invoke-static {p0, p1}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline15;->m(Ljava/nio/file/Path;Ljava/lang/Object;)Z
    ...
    .line 652
    :cond_5
    invoke-static {v2, p3}, Lkotlin/io/path/PathsKt__PathReadWriteKt$$ExternalSyntheticApiModelOutline6;->m(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/InputStream;

    move-result-object p0

    .line 653
    :try_start_0
    invoke-static {v3, p3}, Lkotlin/io/path/PathsKt__PathReadWriteKt$$ExternalSyntheticApiModelOutline6;->m(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/InputStream;
...
.method public static filterPaths(Lorg/apache/commons/io/file/PathFilter;Ljava/util/stream/Stream;Ljava/util/stream/Collector;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .line 698
    :cond_0
    new-instance v0, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda19;

    invoke-direct {v0, p0}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda19;-><init>(Lorg/apache/commons/io/file/PathFilter;)V
...
.method public static getAclEntryList(Ljava/nio/file/Path;)Ljava/util/List;
    ...
    .line 716
    invoke-static {}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline0;->m()Ljava/lang/Class;
    ...
    invoke-static {p0, v0, v1}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline9;->m(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;

    move-result-object p0

    invoke-static {p0}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline1;->m(Ljava/lang/Object;)Ljava/nio/file/attribute/AclFileAttributeView;
    ...
    .line 718
    :cond_0
    invoke-static {p0}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline2;->m(Ljava/nio/file/attribute/AclFileAttributeView;)Ljava/util/List;
...
.method public static isEmptyDirectory(Ljava/nio/file/Path;)Z
    ...
    .line 763
    invoke-static {p0}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;)Ljava/nio/file/DirectoryStream;

    move-result-object p0

    .line 764
    :try_start_0
    invoke-static {p0}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticApiModelOutline19;->m(Ljava/nio/file/DirectoryStream;)Ljava/util/Iterator;
    ...
    .line 765
    invoke-static {p0}, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry$$ExternalSyntheticApiModelOutline2;->m(Ljava/nio/file/DirectoryStream;)V
...
.method public static varargs isNewer(Ljava/nio/file/Path;J[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p0, v1}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline4;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    .line 800
    :cond_0
    invoke-static {p0, p3}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline17;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileTime;
...
.method public static synthetic lambda$filterPaths$0(Lorg/apache/commons/io/file/PathFilter;Ljava/nio/file/Path;)Z
    .locals 2
...
.method public static synthetic lambda$overrideReadOnly$1(Lorg/apache/commons/io/file/DeleteOption;)Z
    .locals 1
...
.method public static synthetic lambda$walk$2(Lorg/apache/commons/io/file/PathFilter;ZLjava/nio/file/Path;)Z
    .locals 0
...
.method public static newDirectoryStream(Ljava/nio/file/Path;Lorg/apache/commons/io/file/PathFilter;)Ljava/nio/file/DirectoryStream;
    ...
    invoke-static {p0, v0}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline14;->m(Ljava/nio/file/Path;Ljava/nio/file/DirectoryStream$Filter;)Ljava/nio/file/DirectoryStream;
...
.method public static varargs overrideReadOnly([Lorg/apache/commons/io/file/DeleteOption;)Z
    .locals 1
    ...
    new-instance v0, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda20;

    invoke-direct {v0}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda20;-><init>()V
...
.method public static readBasicFileAttributes(Ljava/nio/file/Path;)Ljava/nio/file/attribute/BasicFileAttributes;
    ...
    invoke-static {p0, v0, v1}, Lkotlin/io/path/PathTreeWalkKt$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
...
.method public static relativize(Ljava/util/Collection;Ljava/nio/file/Path;ZLjava/util/Comparator;)Ljava/util/List;
    ...
    new-instance v0, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda18;

    invoke-direct {v0, p1}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda18;-><init>(Ljava/nio/file/Path;)V
...
.method public static varargs setReadOnly(Ljava/nio/file/Path;Z[Ljava/nio/file/LinkOption;)Ljava/nio/file/Path;
    ...
    .line 910
    invoke-static {}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline3;->m()Ljava/lang/Class;

    move-result-object v1

    invoke-static {p0, v1, p2}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline9;->m(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;

    move-result-object v1

    invoke-static {v1}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline6;->m(Ljava/lang/Object;)Ljava/nio/file/attribute/DosFileAttributeView;
    ...
    .line 914
    :try_start_0
    invoke-static {v1, p1}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline7;->m(Ljava/nio/file/attribute/DosFileAttributeView;Z)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 921
    :cond_0
    invoke-static {}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline8;->m()Ljava/lang/Class;

    move-result-object p1

    invoke-static {p0, p1, p2}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline9;->m(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;

    move-result-object p1

    invoke-static {p1}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline9;->m(Ljava/lang/Object;)Ljava/nio/file/attribute/PosixFileAttributeView;
    ...
    .line 927
    invoke-static {p1}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline10;->m(Ljava/nio/file/attribute/PosixFileAttributeView;)Ljava/nio/file/attribute/PosixFileAttributes;

    move-result-object p1

    .line 928
    invoke-static {p1}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline11;->m(Ljava/nio/file/attribute/PosixFileAttributes;)Ljava/util/Set;

    move-result-object p1

    .line 929
    invoke-static {}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline12;->m()Ljava/nio/file/attribute/PosixFilePermission;
    ...
    .line 930
    invoke-static {}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline4;->m()Ljava/nio/file/attribute/PosixFilePermission;
    ...
    .line 931
    invoke-static {}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticApiModelOutline5;->m()Ljava/nio/file/attribute/PosixFilePermission;
...
.method public static varargs visitFileTree(Ljava/nio/file/FileVisitor;Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/FileVisitor;
    ...
    .line 1010
    invoke-static {p1, p2}, Lcom/fasterxml/jackson/databind/ext/NioPathDeserializer$$ExternalSyntheticApiModelOutline1;->m(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
...
.method public static visitFileTree(Ljava/nio/file/FileVisitor;Ljava/net/URI;)Ljava/nio/file/FileVisitor;
    ...
    .line 1027
    invoke-static {p1}, Lcom/fasterxml/jackson/databind/ext/NioPathDeserializer$$ExternalSyntheticApiModelOutline2;->m(Ljava/net/URI;)Ljava/nio/file/Path;
...
.method public static visitFileTree(Ljava/nio/file/FileVisitor;Ljava/nio/file/Path;)Ljava/nio/file/FileVisitor;
    ...
    .line 971
    invoke-static {p1, p0}, Lorg/apache/commons/compress/archivers/examples/Archiver$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/nio/file/FileVisitor;)Ljava/nio/file/Path;
...
.method public static visitFileTree(Ljava/nio/file/FileVisitor;Ljava/nio/file/Path;Ljava/util/Set;I)Ljava/nio/file/FileVisitor;
    ...
    .line 991
    invoke-static {p1, p2, p3, p0}, Lkotlin/io/path/DirectoryEntriesReader$$ExternalSyntheticApiModelOutline2;->m(Ljava/nio/file/Path;Ljava/util/Set;ILjava/nio/file/FileVisitor;)Ljava/nio/file/Path;
...
.method public static varargs walk(Ljava/nio/file/Path;Lorg/apache/commons/io/file/PathFilter;IZ[Ljava/nio/file/FileVisitOption;)Ljava/util/stream/Stream;
    ...
    .line 1044
    invoke-static {p0, p2, p4}, Lorg/apache/commons/compress/archivers/zip/ZipSplitReadOnlySeekableByteChannel$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;I[Ljava/nio/file/FileVisitOption;)Ljava/util/stream/Stream;

    move-result-object p0

    new-instance p2, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda17;

    invoke-direct {p2, p1, p3}, Lorg/apache/commons/io/file/PathUtils$$ExternalSyntheticLambda17;-><init>(Lorg/apache/commons/io/file/PathFilter;Z)V
