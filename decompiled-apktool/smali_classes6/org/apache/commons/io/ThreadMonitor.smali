...
# direct methods
.method public constructor <init>(Ljava/lang/Thread;Ljava/time/Duration;)V
    .locals 0
...
.method public static start(Ljava/lang/Thread;Ljava/time/Duration;)Ljava/lang/Thread;
    ...
    .line 69
    invoke-static {p1}, Lorg/apache/commons/io/ThreadMonitor$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/Duration;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {p1}, Lorg/apache/commons/io/ThreadMonitor$$ExternalSyntheticApiModelOutline1;->m(Ljava/time/Duration;)Z
