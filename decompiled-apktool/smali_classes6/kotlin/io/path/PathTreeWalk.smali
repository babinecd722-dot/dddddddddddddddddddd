...
.method public static final synthetic access$getFollowLinks(Lkotlin/io/path/PathTreeWalk;)Z
    ...
    .line 20
    invoke-virtual {p0}, Lkotlin/io/path/PathTreeWalk;->getFollowLinks()Z
...
.method public static final synthetic access$getIncludeDirectories(Lkotlin/io/path/PathTreeWalk;)Z
    ...
    .line 20
    invoke-virtual {p0}, Lkotlin/io/path/PathTreeWalk;->getIncludeDirectories()Z
...
.method public static final synthetic access$getLinkOptions(Lkotlin/io/path/PathTreeWalk;)[Ljava/nio/file/LinkOption;
    ...
    .line 20
    invoke-virtual {p0}, Lkotlin/io/path/PathTreeWalk;->getLinkOptions()[Ljava/nio/file/LinkOption;
...
# virtual methods
.method public final bfsIterator()Ljava/util/Iterator;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final dfsIterator()Ljava/util/Iterator;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final getIncludeDirectories()Z
    .locals 2
...
.method public final getLinkOptions()[Ljava/nio/file/LinkOption;
    .locals 2
...
.method public iterator()Ljava/util/Iterator;
    ...
    .line 38
    invoke-virtual {p0}, Lkotlin/io/path/PathTreeWalk;->isBFS()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lkotlin/io/path/PathTreeWalk;->bfsIterator()Ljava/util/Iterator;
    ...
    :cond_0
    invoke-virtual {p0}, Lkotlin/io/path/PathTreeWalk;->dfsIterator()Ljava/util/Iterator;
...
.method public final yieldIfNeeded(Lkotlin/sequences/SequenceScope;Lkotlin/io/path/PathNode;Lkotlin/io/path/DirectoryEntriesReader;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
