...
# instance fields
.field public final nioFileSystem:Ljava/nio/file/FileSystem;
...
.method public appendingSink(Lokio/Path;Z)Lokio/Sink;
    ...
    .line 137
    invoke-virtual {p0, p1}, Lokio/NioFileSystemWrappingFileSystem;->resolve(Lokio/Path;)Ljava/nio/file/Path;
...
.method public atomicMove(Lokio/Path;Lokio/Path;)V
    ...
    .line 160
    invoke-virtual {p0, p2}, Lokio/NioFileSystemWrappingFileSystem;->resolve(Lokio/Path;)Ljava/nio/file/Path;
...
.method public createDirectory(Lokio/Path;Z)V
    ...
    invoke-static {p2, v0}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline25;->m(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
...
.method public createSymlink(Lokio/Path;Lokio/Path;)V
    ...
    invoke-static {p1, p2, v0}, Lkotlin/io/path/PathsKt__PathUtilsKt$$ExternalSyntheticApiModelOutline19;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
...
.method public list(Lokio/Path;)Ljava/util/List;
    ...
    .line 61
    invoke-virtual {p0, p1, v0}, Lokio/NioFileSystemWrappingFileSystem;->list(Lokio/Path;Z)Ljava/util/List;
...
.method public final list(Lokio/Path;Z)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 68
    :try_start_0
    invoke-static {v0, v3, v2, v3}, Lkotlin/io/path/PathsKt__PathUtilsKt;->listDirectoryEntries$default(Ljava/nio/file/Path;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/List;
    ...
    .line 194
    invoke-static {v0}, Lcom/fasterxml/jackson/databind/ext/NioPathDeserializer$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Ljava/nio/file/Path;
...
.method public openReadOnly(Lokio/Path;)Lokio/FileHandle;
    ...
    invoke-static {v0, v1}, Lokio/NioFileSystemWrappingFileSystem$$ExternalSyntheticApiModelOutline6;->m(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/nio/channels/FileChannel;
...
.method public openReadWrite(Lokio/Path;ZZ)Lokio/FileHandle;
    ...
    invoke-static {p3, p2}, Lokio/NioFileSystemWrappingFileSystem$$ExternalSyntheticApiModelOutline6;->m(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/nio/channels/FileChannel;
...
.method public final resolve(Lokio/Path;)Ljava/nio/file/Path;
    .locals 2
    ...
    invoke-static {v0, p1, v1}, Lkotlin/io/path/PathRelativizer$$ExternalSyntheticApiModelOutline1;->m(Ljava/nio/file/FileSystem;Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
