...
# virtual methods
.method public final acquireTile()Landroidx/recyclerview/widget/TileList$Tile;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final addTile(Landroidx/recyclerview/widget/TileList$Tile;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final flushTileCache(I)V
    .locals 7
    ...
    .line 429
    :cond_0
    invoke-virtual {p0, v1}, Landroidx/recyclerview/widget/AsyncListUtil$2;->removeTile(I)V
    ...
    .line 432
    :cond_2
    invoke-virtual {p0, v2}, Landroidx/recyclerview/widget/AsyncListUtil$2;->removeTile(I)V
...
.method public final getTileStart(I)I
    .locals 1
...
.method public final isTileLoaded(I)Z
    .locals 1
...
.method public loadTile(II)V
    ...
    .line 366
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/AsyncListUtil$2;->isTileLoaded(I)Z
    ...
    .line 372
    :cond_0
    invoke-virtual {p0}, Landroidx/recyclerview/widget/AsyncListUtil$2;->acquireTile()Landroidx/recyclerview/widget/TileList$Tile;
    ...
    .line 376
    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/AsyncListUtil$2;->flushTileCache(I)V

    .line 377
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/AsyncListUtil$2;->addTile(Landroidx/recyclerview/widget/TileList$Tile;)V
...
.method public final removeTile(I)V
    .locals 2
...
.method public final requestTiles(IIIZ)V
    .locals 3
...
.method public updateRange(IIIII)V
    ...
    .line 326
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/AsyncListUtil$2;->getTileStart(I)I

    move-result p1

    .line 327
    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/AsyncListUtil$2;->getTileStart(I)I

    move-result p2

    .line 329
    invoke-virtual {p0, p3}, Landroidx/recyclerview/widget/AsyncListUtil$2;->getTileStart(I)I
    ...
    .line 330
    invoke-virtual {p0, p4}, Landroidx/recyclerview/widget/AsyncListUtil$2;->getTileStart(I)I
    ...
    invoke-virtual {p0, p1, p2, p5, v0}, Landroidx/recyclerview/widget/AsyncListUtil$2;->requestTiles(IIIZ)V
    ...
    invoke-virtual {p0, p2, p1, p5, p4}, Landroidx/recyclerview/widget/AsyncListUtil$2;->requestTiles(IIIZ)V

    goto :goto_0

    .line 343
    :cond_1
    invoke-virtual {p0, p1, p3, p5, p4}, Landroidx/recyclerview/widget/AsyncListUtil$2;->requestTiles(IIIZ)V
    ...
    invoke-virtual {p0, p2, p1, p5, v0}, Landroidx/recyclerview/widget/AsyncListUtil$2;->requestTiles(IIIZ)V
