...
.method public final combineHeaders(Lokhttp3/Headers;Lokhttp3/Headers;)Lokhttp3/Headers;
    ...
    .line 244
    :cond_0
    invoke-virtual {p0, v4}, Lcoil/network/CacheStrategy$Companion;->isContentSpecificHeader(Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_1

    invoke-virtual {p0, v4}, Lcoil/network/CacheStrategy$Companion;->isEndToEnd(Ljava/lang/String;)Z
    ...
    .line 251
    invoke-virtual {p0, v1}, Lcoil/network/CacheStrategy$Companion;->isContentSpecificHeader(Ljava/lang/String;)Z

    move-result v3

    if-nez v3, :cond_4

    invoke-virtual {p0, v1}, Lcoil/network/CacheStrategy$Companion;->isEndToEnd(Ljava/lang/String;)Z
